...
- Built a full real-time pipeline: raw packet capture (Scapy/libpcap) → WebSocket streaming → 3D visualization (Three.js/R3F)
- Designed a protocol/port classification scheme mapping network events to an intuitive visual metaphor
- Handled cross-thread async bridging between a synchronous packet-capture loop and an asyncio WebSocket server
- Implemented auto-reconnecting WebSocket client and live-updating stats dashboard in React
